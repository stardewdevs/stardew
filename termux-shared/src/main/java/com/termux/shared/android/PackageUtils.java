package io.stardew.shared.android;
...
import io.stardew.shared.reflection.ReflectionUtils;
...
public class PackageUtils {
    ...
    public static String getSigningCertificateSHA256DigestForPackage(@NonNull final Context context, @NonNull final String packageName) {
        try {
             ...
             * W/PackageManager: Failed to parse /path/to/io.stardew.tasker.apk: Signature mismatch for shared user: SharedUserSetting{xxxxxxx io.stardew/10xxx}
             */
     ...
     * <manifest
     *     <queries>
     *         <package android:name="io.stardew" />
     *    </queries>
     *
     *    <application
     *        ....
