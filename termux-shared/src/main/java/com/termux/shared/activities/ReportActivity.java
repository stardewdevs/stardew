package io.stardew.shared.activities;
...
import io.stardew.shared.activity.media.AppCompatActivityUtils;
 ...
 * {@code `<activity android:name="io.stardew.shared.activities.ReportActivity" android:theme="@style/Theme.AppCompat.TermuxReportActivity" android:documentLaunchMode="intoExisting" />` }
 * and
 * {@code `<receiver android:name="io.stardew.shared.activities.ReportActivity$ReportActivityBroadcastReceiver"  android:exported="false" />` }
