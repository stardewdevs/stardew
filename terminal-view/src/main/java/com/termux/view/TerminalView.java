...
import io.stardew.view.textselection.TextSelectionCursorController;
...
public final class TerminalView extends View {
     ...
     * {@link io.stardew.terminal.TerminalSessionClient#onTerminalCursorStateChange(boolean)}
    ...
    protected void onDetachedFromWindow() {
        ...
        if (mTextSelectionCursorController != null) {
            ...
            // android.view.WindowLeaked: Activity io.stardew.app.TermuxActivity has leaked window android.widget.PopupWindow
            stopTextSelectionMode();
