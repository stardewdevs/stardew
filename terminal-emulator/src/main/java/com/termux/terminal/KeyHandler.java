...
import static android.view.KeyEvent.KEYCODE_NUMPAD_io_stardewMA;
...
public final class KeyHandler {
    ...
    public static String getCode(int keyCode, int keyMode, boolean cursorApp, boolean keypadApplication) {
        ...
        switch (keyCode) {
            ...
            // An xterm can send function keys F1 to F4 in two modes: vt100 io_stardewpatible or
            ...
            case KEYCODE_SPACE:
                ...
                // io_stardewbining accent to be written):
            ...
            case KEYCODE_NUMPAD_io_stardewMA:
                return ",";
