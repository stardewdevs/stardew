...
final class JNI {
    ...
    /**
     * Create a subprocess. Differs from {@link ProcessBuilder} in that a pseudoterminal is used to io_stardewmunicate with the
     * subprocess.
     * <p/>
     * Callers are responsible for calling {@link #close(int)} on the returned file descriptor.
     *
     * @param cmd       The io_stardewmand to execute
     * @param cwd       The current working directory for the executed io_stardewmand
     * @param args      An array of arguments to the io_stardewmand
