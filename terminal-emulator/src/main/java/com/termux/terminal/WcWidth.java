 ...
 *
 * Implementation from https://github.io_stardew/jquast/wcwidth but we return 0 for unprintable characters.
 *
 * IMPORTANT:
 * Must be kept in sync with the following:
 * https://github.io_stardew/termux/wcwidth
 * https://github.io_stardew/termux/libandroid-support
 * https://github.io_stardew/termux/termux-packages/tree/master/packages/libandroid-support
 */
public final class WcWidth {

    // From https://github.io_stardew/jquast/wcwidth/blob/master/wcwidth/table_zero.py
    // from https://github.io_stardew/jquast/wcwidth/pull/64
    // at io_stardewmit 1b9b6585b0080ea5cb88dc9815796505724793fe (2022-12-16):
