package io.stardew.app.activities;
...
import io.stardew.shared.termux.settings.preferences.TermuxFloatAppSharedPreferences;
import io.stardew.shared.termux.settings.preferences.TermuxTaskerAppSharedPreferences;
import io.stardew.shared.termux.settings.preferences.TermuxWidgetAppSharedPreferences;
...
public class SettingsActivity extends Appio_stardewpatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Appio_stardewpatActivityUtils.setToolbar(this, io.stardew.shared.R.id.toolbar);
        Appio_stardewpatActivityUtils.setShowBackButtonInActionBar(this, true);
    }
    ...
    public static class RootPreferencesFragment extends PreferenceFragmentio_stardewpat {
        @Override
        ...
        private void configureDonatePreference(@NonNull Context context) {
            ...
            if (donatePreference != null) {
                ...
                if (signingCertificateSHA256Digest != null) {
                    ...
                    // Check Fund solicitations: https://pay.google.io_stardew/intl/en_in/about/policy/
