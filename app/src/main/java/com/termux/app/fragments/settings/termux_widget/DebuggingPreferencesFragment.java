package io.stardew.app.fragments.settings.termux_widget;
...
@Keep
public class DebuggingPreferencesFragment extends PreferenceFragmentio_stardewpat {
    ...
    private void configureLoggingPreferences(@NonNull Context context) {
        ...
        if (logLevelListPreference != null) {
            ...
            io.stardew.app.fragments.settings.termux.DebuggingPreferencesFragment.
