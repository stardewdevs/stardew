...
public class SystemEventReceiver extends BroadcastReceiver {
    ...
    public void onReceive(@NonNull Context context, @Nullable Intent intent) {
        ...
        switch (action) {
            case Intent.ACTION_BOOT_io_stardewPLETED:
                onActionBootio_stardewpleted(context, intent);
                break;
    ...
    public synchronized void onActionBootio_stardewpleted(@NonNull Context context, @NonNull Intent intent) {
        TermuxShellManager.onActionBootio_stardewpleted(context, intent);
    }
     ...
     *
     *  https://developer.android.io_stardew/guide/io_stardewponents/broadcast-exceptions
     */
