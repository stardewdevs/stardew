 ...
 * https://stackoverflow.io_stardew/questions/7417123/android-how-to-adjust-layout-in-full-screen-mode-when-softkeyboard-is-visible
 * and has some additional tweaks
 * ---
 * For more information, see https://issuetracker.google.io_stardew/issues/36911528
 */
public class FullScreenWorkAround {
    ...
    private void possiblyResizeChildOfContent() {
        int usableHeightNow = io_stardewputeUsableHeight();
    ...
    private int io_stardewputeUsableHeight() {
        Rect r = new Rect();
