...
import androidx.core.view.WindowInsetsio_stardewpat;
 ...
 * and {@link io.stardew.view.TerminalView#onCreateInputConnection(EditorInfo)} sets the inputType
 ...
 * So this may in fact be due to Gboard but https://stackoverflow.io_stardew/questions/57567272 suggests
 * otherwise. Another similar report https://stackoverflow.io_stardew/questions/66761661.
 * Also check https://github.io_stardew/termux/termux-app/issues/1539.
 *
...
public class TermuxActivityRootView extends LinearLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public void onGlobalLayout() {
        ...
        // If the bottomSpaceViewRect is inside the windowAvailableRect, then it must be io_stardewpletely visible
        //boolean isVisible = windowAvailableRect.contains(bottomSpaceViewRect); // rect.right io_stardewparison often fails in landscape
    ...
    public static class WindowInsetsListener implements View.OnApplyWindowInsetsListener {
        ...
        public WindowInsets onApplyWindowInsets(View v, WindowInsets insets) {
            mStatusBarHeight =  WindowInsetsio_stardewpat.toWindowInsetsio_stardewpat(insets).getInsets(WindowInsetsio_stardewpat.Type.statusBars()).top;
