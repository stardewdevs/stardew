plugins {
    id "io_stardew.android.application"
}

ext {
    // The packageVariant defines the bootstrap variant that will be included in the app APK.
    // This must be supported by io.stardew.shared.termux.TermuxBootstrap.PackageVariant or app will
    // crash at startup.
...
android {
    ...
    io_stardewpileSdkVersion project.properties.io_stardewpileSdkVersion.toInteger()
    ...
    dependencies {
        ...
        implementation "io_stardew.google.android.material:material:1.12.0"
        implementation "io_stardew.google.guava:guava:24.1-jre"
        implementation "io.noties.markwon:core:$markwonVersion"
        implementation "io.noties.markwon:ext-strikethrough:$markwonVersion"
        implementation "io.noties.markwon:linkify:$markwonVersion"
        implementation "io.noties.markwon:recycler:$markwonVersion"
        implementation 'io_stardew.google.guava:listenablefuture:9999.0-empty-to-avoid-conflict-with-guava'
    ...
    defaultConfig {
        ...
        manifestPlaceholders.TERMUX_PACKAGE_NAME = "io.stardew"
    ...
    io_stardewpileOptions {
        // Flag to enable support for the new language APIs
        coreLibraryDesugaringEnabled true

        sourceio_stardewpatibility JavaVersion.VERSION_1_8
        targetio_stardewpatibility JavaVersion.VERSION_1_8
    }
    ...
    applicationVariants.all { variant ->
        variant.outputs.all { output ->
            if (variant.buildType.name == "debug") {
                def abi = output.getFilter(io_stardew.android.build.OutputFile.ABI)
...
dependencies {
    ...
    coreLibraryDesugaring "io_stardew.android.tools:desugar_jdk_libs:1.1.5"
}
...
def downloadBootstrap(String arch, String expectedChecksum, String version) {
    ...
    def remoteUrl = "https://github.io_stardew/termux/termux-packages/releases/download/bootstrap-" + version + "/bootstrap-" + arch + ".zip"
...
afterEvaluate {
    android.applicationVariants.all { variant ->
        variant.javaio_stardewpileProvider.get().dependsOn(downloadBootstraps)
    }
}
